...
public class SampleData {
    ...
    public static final Album aLoveSomeBody = new Album("A Love Somebody", asList(new Track("Love under moon", 467), new Track("Love on beach", 442)), asList(johnLennon, johnColtrane));
    ...
    public static final Album manyTrackAlbum = new Album("sample Short Album-2", asList(new Track("short track", 30),
            new Track("short track 2", 30), 
            new Track("short track 3", 30), 
            new Track("short track 4", 30), 
            new Track("short track 5", 30)), asList(johnColtrane));

    public static Stream<Album> albums = Stream.of(aLoveSupreme, sampleShortAlbum, manyTrackAlbum, aLoveSomeBody);
    ...
    public static Stream<Artist> getArtists() {
        return Stream.of(johnColtrane, johnLennon, theBeatles, paulMcCartney, georgeHarrison, ringoStarr);
    }
